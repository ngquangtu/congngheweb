                ...
                <div class="container-fluid" style="margin-top: 5%">
                    ...
                    <?php while($row = mysqli_fetch_assoc($query)) { ?>
                            <tr>
                                ...
                                <td style="text-align:left"><?php echo $row['thoigian'] ?></td>
                                <td style="text-align:left"><?php echo $row['tacvu'] ?></td>
                                <td style="text-align:left"><?php echo $row['nguoithuchien'] ?></td>
                            </tr>
                    <?php
                            }
                        } else {
